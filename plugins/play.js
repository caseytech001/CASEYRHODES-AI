  ...
  try {
    ...
    if (command === "play") {
      ...
      await client.sendMessage(message.from, {
        text: "*ɴᴊᴀʙᴜʟᴏ ᴊʙ* " + toFancyFont("searching for") + " \"" + query + "\"",
        viewOnce: true
      }, { quoted: message });
      ...
      try {
        ...
        return await client.sendMessage(message.from, {
          text: "*ɴᴊᴀʙᴜʟᴏ ᴊʙ* " + toFancyFont("couldn't process your request. Please try again later"),
          viewOnce: true,
          mentions: [message.sender]
        }, { quoted: message });
      }
      ...
      try {
        ...
        return await client.sendMessage(message.from, {
          text: "*ɴᴊᴀʙᴜʟᴏ ᴊʙ* " + toFancyFont("failed to send audio file"),
          viewOnce: true,
          mentions: [message.sender]
        }, { quoted: message });
      }
    ...
    await client.sendMessage(message.from, {
      text: "*ɴᴊᴀʙᴜʟᴏ ᴊʙ* " + toFancyFont("encountered an error. Please try again"),
      viewOnce: true,
      mentions: [message.sender]
    }, { quoted: message });
  }
