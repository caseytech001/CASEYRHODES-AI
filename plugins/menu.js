...
const categoryImages = {
  "main": "https://files.catbox.moe/y3j3kl.jpg", // Main menu image
  "download": "https://files.catbox.moe/zi6n3a.jpg", // download menu image URL
  "group": "https://files.catbox.moe/1blu91.jpg", // group menu image URL
  "fun": "https://files.catbox.moe/jicpyd.jpg", // fun menu image URL
  "owner": "https://files.catbox.moe/72mwmv.jpg", // owner menu image URL
  "ai": "https://files.catbox.moe/k3wgqy.jpg", // AI menu image URL
  "anime": "https://files.catbox.moe/smiy7t.jpg", // anime menu image URL
  "converter": "https://files.catbox.moe/omgszj.jpg", // converter menu image URL
  "other": "https://files.catbox.moe/b6dfzj.jpg", // other menu image URL
  "reactions": "https://files.catbox.moe/k3wgqy.jpg", // reactions menu image URL
};

// Image fetch utility
async function fetchMenuImage(category = "main") {
  const imageUrl = categoryImages[category] || categoryImages.main;
...
const menu = async (m, Matrix) => {
  try {
    ...
    // Determine which category image to fetch
    let category = "main";
    if (cmd.endsWith("-menu")) {
      category = cmd.replace("-menu", "");
    }
    
    // Fetch image for the specific category
    const menuImage = await fetchMenuImage(category);
          ...
          quoted: {
            ...
            message: {
                contactMessage: {
                    ...
                    vcard: "BEGIN:VCARD\nVERSION:3.0\nFN: Caseyrhodes VERIFIED ✅\nORG:CASEYRHODES-TECH BOT;\nTEL;type=CELL;type=VOICE;waid=254740007567:+254840007567\nEND:VCARD"
                }
            }
          }
        });
